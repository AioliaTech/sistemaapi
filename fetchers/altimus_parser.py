...
class AltimusParser(BaseParser):
    ...
    def parse(self, data: Any, url: str) -> List[Dict]:
        ...
        if isinstance(data, str):
            ...
            # JSON tradicional com chave "veiculos"
            if "veiculos" in data:
                print("[DEBUG AltimusParser] Detectado como DICT (JSON tradicional)")
            ...
            # XML parseado - estrutura {'estoque': {'veiculo': [...]}}
                ...
                print("[DEBUG AltimusParser] Detectado como DICT de XML parseado (estoque)")
                ...
                print(f"[DEBUG AltimusParser] Encontrados {len(veiculos_list)} veículos em estoque")
            ...
            # XML parseado - estrutura {'CargaVeiculos': {'Veiculo': [...]}}
                ...
                print("[DEBUG AltimusParser] Detectado como DICT de XML parseado (CargaVeiculos)")
    ...
    def _parse_xml_dict_vehicles(self, veiculos_list: List[Dict]) -> List[Dict]:
        ...
        print(f"[DEBUG _parse_xml_dict_vehicles] Processando {len(veiculos_list)} veículos")
        ...
        for v in veiculos_list:
            ...
            print(f"[DEBUG _parse_xml_dict_vehicles] Veículo: ID={veiculo.get('id')} - Ano: {veiculo.get('ano')} - {len(fotos)} fotos")
